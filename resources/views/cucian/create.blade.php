...
<title>Kyy Laundry | Tambah Cucian</title>
                ...
                <form action="{{ route('cucian.store') }}" method="post">
                    ...
                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                        ...
                        <div class="md:col-span-5 text-right pt-4">
                          <div class="inline-flex items-end">
                            <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded"><a href="{{ route('cucian.index') }}">Kembali</a></button>
                          </div>
                          <div class="inline-flex items-end">
